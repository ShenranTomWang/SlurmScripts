...
export DATA_DIR="/scratch/st-jjnunez-1/shenranw/Interpretation/data/topics_classification/Llama-3.2-1B-topics-classification"
export MODEL_DIR="/scratch/st-jjnunez-1/shenranw/Interpretation/out/Llama-3.2-1B"
python ./test_classifier.py --data_dir $DATA_DIR --model_dir $MODEL_DIR --out_dir $MODEL_DIR

export DATA_DIR="/scratch/st-jjnunez-1/shenranw/Interpretation/data/topics_classification/gpt2-topics-classification"
export MODEL_DIR="/scratch/st-jjnunez-1/shenranw/Interpretation/out/gpt2"
