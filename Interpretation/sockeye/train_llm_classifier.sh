...
export CONFIG_DIR="/scratch/st-jzhu71-1/shenranw/Interpretation/data/topics_classification/Llama-3.2-1B-topics-classification"
export OUT_DIR="/scratch/st-jzhu71-1/shenranw/Intepretation/out/Llama-3.2-1B"
export HIDDEN_DIMS=2048
python ./train_classifier.py --config_dir $CONFIG_DIR --out_dir $OUT_DIR --hidden_dims $HIDDEN_DIMS

export CONFIG_DIR="/scratch/st-jzhu71-1/shenranw/Interpretation/data/topics_classification/gpt2-topics-classification"
export OUT_DIR="/scratch/st-jzhu71-1/shenranw/Intepretation/out/gpt2"
