...
apptainer run -C --nv --home /project/6080355/shenranw/Matcha-TTS -B /project -B /scratch /scratch/shenranw/llm_env.sif bash /project/6080355/shenranw/scripts/train_matcha_objiwe.sh