...
python extract_activations.py --model $MODEL --add_newlines --task class_to_class --k 4 --split dev
python extract_activations.py --model $MODEL --add_newlines --task class_to_class_random --k 4 --split dev
