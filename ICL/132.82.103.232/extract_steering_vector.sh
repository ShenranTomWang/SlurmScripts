...
python extract_activations.py --model $MODEL --dataset tweet_eval-hate --k 16 --split train --out_dir $OUT_DIR --operator ZambaOperator --stream steer --device $DEVICE

export MODEL="nvidia/Hymba-1.5B-Base"
export OUT_DIR="out/Hymba-1.5B-Base"
python extract_activations.py --model $MODEL --dataset tweet_eval-hate --k 16 --split train --out_dir $OUT_DIR --operator HymbaOperator --stream steer --device $DEVICE

export MODEL="state-spaces/mamba-1.4b-hf"
export OUT_DIR="out/mamba-1.4b-hf"
python extract_activations.py --model $MODEL --dataset tweet_eval-hate --k 16 --split train --out_dir $OUT_DIR --operator MambaOperator --stream steer --device $DEVICE

export MODEL="AntonV/mamba2-1.3b-hf"
export OUT_DIR="out/mamba2-1.3b-hf"
python extract_activations.py --model $MODEL --dataset tweet_eval-hate --k 16 --split train --out_dir $OUT_DIR --operator Mamba2Operator --stream steer --device $DEVICE
