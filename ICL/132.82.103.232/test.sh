...
export LOG_DIR="logs/Hymba-1.5B-Base/0"
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_no_demo.log --use_template
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original_incorrect_mapping --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping_no_demo.log --use_template

export MODEL="Qwen/Qwen2.5-1.5B"
export OUT_DIR="out/Qwen2.5-1.5B"
export LOG_DIR="logs/Qwen2.5-1.5B/0"
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_no_demo.log --use_template
python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original_incorrect_mapping --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping_no_demo.log --use_template

export MODEL="meta-llama/Llama-3.2-1B"
export OUT_DIR="out/Llama-3.2-1B"
export LOG_DIR="logs/Llama-3.2-1B/0"
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_no_demo.log --use_template
python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original_incorrect_mapping --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping_no_demo.log --use_template

export MODEL="google/gemma-3-1b-pt"
export OUT_DIR="out/gemma-3-1b-pt"
export LOG_DIR="logs/gemma-3-1b-pt/0"
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_no_demo.log --use_template
python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original_incorrect_mapping --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping_no_demo.log --use_template

export MODEL="state-spaces/mamba-1.4b-hf"
export OUT_DIR="out/mamba-1.4b-hf"
export LOG_DIR="logs/mamba-1.4b-hf/0"
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_no_demo.log --use_template
python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original_incorrect_mapping --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping_no_demo.log --use_template

export MODEL="AntonV/mamba2-1.3b-hf"
export OUT_DIR="out/mamba2-1.3b-hf"
export LOG_DIR="logs/mamba2-1.3b-hf/0"
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_no_demo.log --use_template
python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original_incorrect_mapping --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping_no_demo.log --use_template

export MODEL="Zyphra/Zamba2-1.2B"
export OUT_DIR="out/Zamba2-1.2B"
export LOG_DIR="logs/Zamba2-1.2B/0"
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_no_demo.log --use_template
python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original_incorrect_mapping --k 0 --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping_no_demo.log --use_template
...
do
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_random.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original_incorrect_mapping --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original_0_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_0_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_25_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_50_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_original_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_75_correct.log --use_template
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_random.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original_incorrect_mapping --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original_0_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_0_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_25_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_50_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_original_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_75_correct.log --use_template
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_random.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original_incorrect_mapping --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original_0_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_0_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_25_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_50_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_original_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_75_correct.log --use_template

    export MODEL="google/gemma-3-1b-pt"
    export OUT_DIR="out/gemma-3-1b-pt"
    export LOG_DIR="logs/gemma-3-1b-pt/$k"--use_template
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_random.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original_incorrect_mapping --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original_0_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_0_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_25_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_50_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_original_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_75_correct.log --use_template
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_random.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original_incorrect_mapping --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original_0_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_0_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_25_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_50_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_original_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_75_correct.log --use_template
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_random.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original_incorrect_mapping --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original_0_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_0_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_25_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_50_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_original_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_75_correct.log --use_template
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_random.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original_incorrect_mapping --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_incorrect_mapping.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original_0_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_0_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_25_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_50_correct.log --use_template
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_original_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_original/log_75_correct.log --use_template
done