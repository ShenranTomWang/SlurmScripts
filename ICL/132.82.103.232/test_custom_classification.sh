...
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_25_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_50_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_75_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification_random --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_random.log
...
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task classification_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_25_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task classification_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_50_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task classification_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_75_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task classification_random --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_random.log
...
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task classification_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_25_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task classification_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_50_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task classification_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_75_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task classification_random --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_random.log
...
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task classification_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_25_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task classification_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_50_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task classification_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_75_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task classification_random --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_random.log
...
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification_25_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_25_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification_50_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_50_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification_75_correct --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_75_correct.log
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification_random --k $k --device $DEVICE --log_file $LOG_DIR/classification/log_random.log
