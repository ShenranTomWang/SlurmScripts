...
python layer_steer.py --model $MODEL --operator MambaOperator --task function_vectors_original --device $DEVICE --mean_pool

export MODEL="AntonV/mamba2-1.3b-hf"
python layer_steer.py --model $MODEL --operator Mamba2Operator --task function_vectors_original --device $DEVICE --mean_pool

export MODEL="Zyphra/Zamba2-1.2B"
python layer_steer.py --model $MODEL --operator ZambaOperator --task function_vectors_original --device $DEVICE --mean_pool