...
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --add_newlines --task analysis_classification --k 4 --n_skips 1 --device $DEVICE
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --add_newlines --task analysis_classification_random --k 4 --n_skips 1 --device $DEVICE
...
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator TransformerOperator --add_newlines --task analysis_classification --k 4 --n_skips -1 --device $DEVICE
python test_custom.py --model $MODEL --out_dir $OUT_DIR --operator TransformerOperator --add_newlines --task analysis_classification_random --k 4 --n_skips -1 --device $DEVICE
