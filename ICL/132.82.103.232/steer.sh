...
python steer.py --model $MODEL --dataset tweet_eval-hate --out_dir $OUT_DIR --load_dir $OUT_DIR --operator TransformerOperator --n_skips -1 intervene_direct
...
python steer.py --model $MODEL --dataset tweet_eval-hate --out_dir $OUT_DIR --load_dir $OUT_DIR --operator ZambaOperator --n_skips 1 intervene_direct
...
python steer.py --model $MODEL --dataset tweet_eval-hate --out_dir $OUT_DIR --load_dir $OUT_DIR --operator HymbaOperator --n_skips 1 intervene_direct
...
python steer.py --model $MODEL --dataset tweet_eval-hate --out_dir $OUT_DIR --load_dir $OUT_DIR --operator MambaOperator --n_skips -1 intervene_direct
