...
python extract_activations.py --model $MODEL --add_newlines --task analysis_classification --k 4 --split demo --out_dir $OUT_DIR --operator TransformerOperator --stream attn --device $DEVICE
python extract_activations.py --model $MODEL --add_newlines --task analysis_classification_random --k 4 --split demo --out_dir $OUT_DIR --operator TransformerOperator --stream attn --device $DEVICE
...
python extract_activations.py --model $MODEL --add_newlines --task analysis_classification --k 4 --split demo --out_dir $OUT_DIR --operator RWKVOperator --stream attn --device $DEVICE
python extract_activations.py --model $MODEL --add_newlines --task analysis_classification_random --k 4 --split demo --out_dir $OUT_DIR --operator RWKVOperator --stream attn --device $DEVICE

export MODEL="state-spaces/mamba-1.4b-hf"
export OUT_DIR="out/mamba-1.4b-hf"
python extract_activations.py --model $MODEL --add_newlines --task analysis_classification --k 4 --split demo --out_dir $OUT_DIR --operator MambaOperator --stream attn --device $DEVICE
python extract_activations.py --model $MODEL --add_newlines --task analysis_classification_random --k 4 --split demo --out_dir $OUT_DIR --operator MambaOperator --stream attn --device $DEVICE
