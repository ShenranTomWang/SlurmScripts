...
python extract_activations.py --model $MODEL --task function_vectors --k 16 --split dev --out_dir $OUT_DIR --operator Qwen2Operator --device $DEVICE attn_mean
...
python extract_activations.py --model $MODEL --task function_vectors --k 16 --split dev --out_dir $OUT_DIR --operator HymbaOperator --device $DEVICE attn_mean
...
python extract_activations.py --model $MODEL --task function_vectors --k 16 --split dev --out_dir $OUT_DIR --operator MambaOperator --device $DEVICE attn_mean
...
python extract_activations.py --model $MODEL --task function_vectors --k 16 --split dev --out_dir $OUT_DIR --operator Mamba2Operator --device $DEVICE attn_mean
...
python extract_activations.py --model $MODEL --task function_vectors --k 16 --split dev --out_dir $OUT_DIR --operator ZambaOperator --device $DEVICE attn_mean
...
python extract_activations.py --model $MODEL --task function_vectors --k 16 --split dev --out_dir $OUT_DIR --operator LlamaOperator --device $DEVICE attn_mean
