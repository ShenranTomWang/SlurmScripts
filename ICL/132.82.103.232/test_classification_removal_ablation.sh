...
do
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log.log zero_ablation --p $p
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log_scan.log zero_ablation --p $p --stream scan
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log_attn.log zero_ablation --p $p --stream attn
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/mean_ablation/$p/log.log mean_ablation --p $p
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/mean_ablation/$p/log_scan.log mean_ablation --p $p --stream scan
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/mean_ablation/$p/log_attn.log mean_ablation --p $p --stream attn
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/exclusion_mean_ablation/$p/log.log exclusion_mean_ablation --p $p --exclude_p 0.2
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/exclusion_mean_ablation/$p/log_scan.log exclusion_mean_ablation --p $p --stream scan --exclude_p 0.2
    python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/exclusion_mean_ablation/$p/log_attn.log exclusion_mean_ablation --p $p --stream attn --exclude_p 0.2
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log.log zero_ablation --p $p
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log.log zero_ablation --p $p
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log.log zero_ablation --p $p
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log.log zero_ablation --p $p
    ...
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log.log zero_ablation --p $p
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log_scan.log zero_ablation --p $p --stream scan
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/zero_ablation/$p/log_attn.log zero_ablation --p $p --stream attn
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/mean_ablation/$p/log.log mean_ablation --p $p
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/mean_ablation/$p/log_scan.log mean_ablation --p $p --stream scan
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/mean_ablation/$p/log_attn.log mean_ablation --p $p --stream attn
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/exclusion_mean_ablation/$p/log.log exclusion_mean_ablation --p $p --exclude_p 0.2
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/exclusion_mean_ablation/$p/log_scan.log exclusion_mean_ablation --p $p --stream scan --exclude_p 0.2
    python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task classification --k $k --device $DEVICE --log_file $LOG_DIR/classification/exclusion_mean_ablation/$p/log_attn.log exclusion_mean_ablation --p $p --stream attn --exclude_p 0.2
