...
python test.py --model $MODEL --out_dir $OUT_DIR --operator HymbaOperator --task function_vectors_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_random/log_random.log
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator Qwen2Operator --task function_vectors_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_random/log_random.log
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator LlamaOperator --task function_vectors_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_random/log_random.log
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator ForwardWrapperTransformerOperator --task function_vectors_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_random/log_random.log
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator MambaOperator --task function_vectors_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_random/log_random.log
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator Mamba2Operator --task function_vectors_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_random/log_random.log
...
python test.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_random --k $k --device $DEVICE --log_file $LOG_DIR/function_vectors_random/log_random.log
