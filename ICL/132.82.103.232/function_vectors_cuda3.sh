...
python function_vectors.py --model $MODEL --out_dir $OUT_DIR --operator ZambaOperator --task function_vectors_incorrect_mapping --device $DEVICE --fv_load_dir $OUT_DIR --seed 100 --use_template AIE
