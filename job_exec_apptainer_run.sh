...
apptainer run -C --nv --home /project/6080355/shenranw -B /project -B /scratch /project/6080355/shenranw/scripts/matcha_tts.sif bash /project/6080355/shenranw/scripts/train_objiwe.sh