...
apptainer run -C --nv --home /project/6080355/shenranw -B /project -B /scratch /scratch/shenranw/llm_env.sif bash /project/6080355/shenranw/scripts/apptainer_run/setup_vocos_conda.sh